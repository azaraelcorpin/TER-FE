  ...
  <v-card style="overflow-y: scroll;height: 90vh;overflow-x: hidden; position: relative;" >
    ...
    <v-card style="position: sticky;top: 0;z-index: 1;"> 
      <div class="Hcontainer">
        ...
        <div class="item"><strong>Subject:</strong>&nbsp;{{evaluateeInfo.subjcode}}</div>
        <div class="item"><strong>Time/Day:</strong>&nbsp;{{evaluateeInfo.time}}&nbsp;{{ evaluateeInfo.days }}</div>
        <div class="item"><strong>Section:</strong>&nbsp;{{evaluateeInfo.section}}</div>
      </div>
